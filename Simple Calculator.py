...
button_add = Button(root,text="+",padx=25,pady=25, command=add)
button_subtract = Button(root,text="-",padx=25,pady=25, command=subtract)
button_multiplication = Button(root,text="*",padx=25,pady=25,command=multiplication)
button_division = Button(root,text="//",padx=25,pady=25,command=division)
button_clear = Button(root,text="AC",padx=25,pady=25,command=clear)
button_equal = Button(root,text="=",padx=25,pady=25,command=equal)
